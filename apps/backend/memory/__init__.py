...
Public API:
    ...
    - get_global_memory_dir() -> Path
    - append_global_pattern(pattern) -> None
    - load_global_patterns() -> list[str]
    - append_global_gotcha(gotcha) -> None
    - load_global_gotchas() -> list[str]
    - append_global_preference(preference) -> None
    - load_global_preferences() -> list[str]
    - clear_global_memory() -> None
"""
...
from .global_memory import (
    append_global_gotcha,
    append_global_pattern,
    append_global_preference,
    clear_global_memory,
    load_global_gotchas,
...
# Directory management
from .paths import clear_memory, get_global_memory_dir, get_memory_dir, get_session_insights_dir
