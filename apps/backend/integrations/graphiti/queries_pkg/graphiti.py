...
class GraphitiMemory:
    ...
    def __init__(
        ...
        Args:
            ...
            group_id_mode: How to scope the memory namespace:
                ...
                - "global": User-wide memory across all projects
        """
    ...
    def group_id(self) -> str:
        ...
        Returns:
            ...
            - In GLOBAL mode: user-scoped ID based on home directory hash
        """
        if self.group_id_mode == GroupIdMode.GLOBAL:
            home_hash = hashlib.md5(
                str(Path.home()).encode(), usedforsecurity=False
            ).hexdigest()[:8]
            return f"global_user_{home_hash}"
        elif self.group_id_mode == GroupIdMode.PROJECT:
