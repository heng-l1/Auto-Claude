...
class TestModuleExports:
    ...
    def test_exports_get_global_graphiti_memory(self):
        """Verify get_global_graphiti_memory is exported."""
        from integrations.graphiti import memory

        assert hasattr(memory, "get_global_graphiti_memory")
    ...
    def test_all_list_length_matches_expected(self):
        ...
        # Expected: 15 exports based on the __all__ list in memory.py
        # (14 original + get_global_graphiti_memory for global memory support)
        assert len(memory.__all__) == 15
