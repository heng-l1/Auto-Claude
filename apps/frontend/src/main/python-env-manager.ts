...
export class PythonEnvManager extends EventEmitter {
  ...
  private async checkDepsInstalled(): Promise<boolean> {
    ...
    try {
      ...
      // See: https://github.com/ArcaneAgent/Auto-Claude/issues/359
      //
...
`;
   ...
   *
   * @see https://github.com/ArcaneAgent/Auto-Claude/issues/176
   * @see https://github.com/ArcaneAgent/Auto-Claude/issues/810
