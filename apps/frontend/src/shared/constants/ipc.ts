...
export const IPC_CHANNELS = {
  ...
  TASK_WORKTREE_SUBTASK_DIFFS: 'task:worktreeSubtaskDiffs',
  ...
  TERMINAL_SET_PR_DISCUSSION_CONTEXT: 'terminal:setPRDiscussionContext',  // Renderer -> Main: tag terminal as PR discussion
  ...
  TERMINAL_FOREGROUND_PROCESS: 'terminal:foregroundProcess',  // Foreground process name changed (main -> renderer)
  TERMINAL_INVOKE_CLAUDE_REMOTE: 'terminal:invokeClaudeRemote',  // Invoke Claude in a remote/multiplexer session (simple command)
...
// GitLab integration
  ...
  GITHUB_PR_RESOLVE_CONFLICTS: 'github:pr:resolveConflicts',
  GITHUB_PR_RESOLVE_CONFLICTS_PROGRESS: 'github:pr:resolveConflictsProgress',
  GITHUB_PR_RESOLVE_CONFLICTS_COMPLETE: 'github:pr:resolveConflictsComplete',
  GITHUB_PR_RESOLVE_CONFLICTS_ERROR: 'github:pr:resolveConflictsError',
  ...
  // GitHub PR Notes operations (user notes persisted per PR)
  ...
  GIT_GET_USERNAME: 'git:getUsername',
  ...
  CLAUDE_CODE_GET_LAST_RESPONSE: 'claudeCode:getLastResponse',  // Extract last assistant text from Claude session JSONL
  ...
  MCP_GET_CLAUDE_CODE_SERVERS: 'mcp:getClaudeCodeServers', // Import MCP servers from ~/.claude.json
