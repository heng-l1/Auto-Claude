...
export interface ElectronAPI {
  ...
  setTerminalPRDiscussionContext: (id: string, context: { prNumber: number; repo: string } | undefined) => void;
  ...
  getGitUsername: (projectPath: string) => Promise<IPCResult<string | null>>;
