...
export const Terminal = forwardRef<TerminalHandle, TerminalProps>(function Terminal({
  ...
  // Initialize xterm.js terminal UI
  const { terminalRef, xtermRef, fitAddonRef, fit, write, writeln, focus, dispose, cols, rows, dimensionsReady, handleCopy, handlePaste, selectAll, clearTerminal } = useXterm({
    terminalId: id,
...
Please confirm you're ready by saying: I'm ready to work on ${selectedTask.title} - Context is loaded.`;
  ...
  // Context menu handler for right-click on terminal area
