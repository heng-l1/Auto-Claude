import { GitPullRequest, User, Clock, FileDiff, Loader2, Check } from 'lucide-react';
...
interface PRListProps {
  ...
  checkedPRNumbers?: Set<number>;
  /** Toggle checkbox for a PR */
  onToggleCheck?: (prNumber: number) => void;
}
    ...
    <ScrollArea className="flex-1">
      <div className="divide-y divide-border">
        {prs.map((pr) => {
          ...
          const isChecked = checkedPRNumbers?.has(pr.number) ?? false;
