...
import type { WorktreeStatus, MergeConflict, MergeStats, GitConflictInfo, SupportedIDE, MergeProgress, MergeLogEntry, MergeLogEntryType } from '../../../../shared/types';
        ...
        {worktreeStatus.worktreePath && (
          <div className="flex gap-2 mt-3">
            ...
            >
              ...
              {t('taskReview:terminal.openClaudeCode')}
            </Button>
            <Button
              variant="outline"
              size="sm"
            ...
            >
              ...
              {t('taskReview:terminal.openTerminal')}
            </Button>
          </div>
        )}
      </div>
