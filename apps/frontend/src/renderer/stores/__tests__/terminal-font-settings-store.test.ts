...
describe('terminal-font-settings-store', () => {
  ...
  describe('Store initialization', () => {
    it('should initialize with OS-specific defaults', () => {
      ...
      expect(state.fontFamily).toEqual(['Ubuntu Mono', 'Source Code Pro', 'Liberation Mono', 'DejaVu Sans Mono', 'MesloLGS NF', 'Hack Nerd Font', 'FiraCode Nerd Font', 'monospace']);
  ...
  describe('OS-specific defaults', () => {
    it('should initialize with Windows defaults', async () => {
      ...
      expect(windowsStore.fontFamily).toEqual(['Cascadia Code', 'Consolas', 'Courier New', 'MesloLGS NF', 'Hack Nerd Font', 'FiraCode Nerd Font', 'monospace']);
    ...
    it('should initialize with macOS defaults', async () => {
      ...
      expect(macStore.fontFamily).toEqual(['SF Mono', 'Menlo', 'Monaco', 'MesloLGS NF', 'Hack Nerd Font', 'FiraCode Nerd Font', 'monospace']);
