...
function getOSDefaults(): TerminalFontSettings {
  if (isWindows()) {
    return {
      fontFamily: ['Cascadia Code', 'Consolas', 'Courier New', 'MesloLGS NF', 'Hack Nerd Font', 'FiraCode Nerd Font', 'monospace'],
      fontSize: 14,
      fontWeight: 400,
      lineHeight: 1.2,
      letterSpacing: 0,
  ...
  if (isMacOS()) {
    return {
      fontFamily: ['SF Mono', 'Menlo', 'Monaco', 'MesloLGS NF', 'Hack Nerd Font', 'FiraCode Nerd Font', 'monospace'],
      fontSize: 13,
      fontWeight: 400,
      lineHeight: 1.2,
      letterSpacing: 0,
  ...
  if (isLinux()) {
    return {
      fontFamily: ['Ubuntu Mono', 'Source Code Pro', 'Liberation Mono', 'DejaVu Sans Mono', 'MesloLGS NF', 'Hack Nerd Font', 'FiraCode Nerd Font', 'monospace'],
      fontSize: 13,
      fontWeight: 400,
      lineHeight: 1.2,
      letterSpacing: 0,
  ...
  return {
    fontFamily: ['MesloLGS NF', 'Hack Nerd Font', 'FiraCode Nerd Font', 'monospace'],
    fontSize: 14,
    fontWeight: 400,
    lineHeight: 1.2,
    letterSpacing: 0,
