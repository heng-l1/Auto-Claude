...
**"Project"** means Auto Claude, a multi-agent autonomous coding framework, currently available at https://github.com/ArcaneAgent/Auto-Claude.

**"Project Owner"** means the Auto Claude maintainers and any designated successors or assignees.
