...
| New features / architecture changes | Start a [GitHub Discussion](https://github.com/ArcaneAgent/Auto-Claude/discussions) or ask in [Discord](https://discord.com/channels/1448614759996854284/1451298184612548779) first |
...
git clone https://github.com/ArcaneAgent/Auto-Claude.git
cd Auto-Claude
...
> **Note:** For regular usage, we recommend downloading the pre-built releases from [GitHub Releases](https://github.com/ArcaneAgent/Auto-Claude/releases). Running from source is primarily for contributors and those testing unreleased features.
...
Our pre-commit hooks automatically check for missing encoding parameters. See [PR #782](https://github.com/ArcaneAgent/Auto-Claude/pull/782) for the comprehensive encoding fix and [guides/windows-development.md](guides/windows-development.md) for Windows-specific development guidance.
...
git remote add upstream https://github.com/ArcaneAgent/Auto-Claude.git
```
